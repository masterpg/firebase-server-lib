...
import { AuthServiceDI, AuthServiceModule } from '../base-service'
...
import { StorageNode, StorageNodeShareSettings, StorageNodeType, StoreServiceDI, StoreServiceModule } from '../base-service'
...
namespace StorageService {
   ...
   * @param input
   */
  export function validateShareSettingInput(input?: StorageNodeShareSettingsInput | null): void {
   ...
   * @param nodes
   */
  export function sortNodes<NODE extends StorageNode>(nodes: NODE[]): NODE[] {
    nodes.sort((a, b) => {
