...
import { StorageNodeShareSettings, StorageUser, UploadDataItem } from '../../../../../src/lib'
import { StorageService, StorageServiceDI } from '../../../../../src/example/services'
...
describe('StorageService', () => {
  beforeEach(async () => {
    ...
    storageService = testingModule.get<StorageService>(StorageServiceDI.symbol)
